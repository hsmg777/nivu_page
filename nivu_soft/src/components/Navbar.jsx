...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-4 left-4 right-4 z-50 bg-[#071952] text-white rounded-full px-8 py-2 shadow-md backdrop-blur-sm">
      <div className="flex items-center justify-between w-full">

        {/* Logo */}
        <Link to="/" className="flex items-center gap-2">
          <img src="/images/logo_nube.png" alt="Nuvi Soft" className="h-10 md:h-12 w-auto object-contain" />
          <span className="text-white font-semibold text-lg md:text-xl">Nuvi Soft</span>
        </Link>
          ...
          <li><Link to="/" className="hover:underline">Inicio</Link></li>
            ...
            <li className="relative dropdown-hover">
                ...
                <ul className="dropdown-content">
                    <li><Link to="/servicios/web">Desarrollo Web</Link></li>
                    <li><Link to="/servicios/sistemas">Sistemas a medida</Link></li>
                </ul>
            </li>
